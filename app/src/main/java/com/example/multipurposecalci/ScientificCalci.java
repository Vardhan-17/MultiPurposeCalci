...
public class ScientificCalci extends AppCompatActivity {
    ...
    Double num1, num2, answer,deg=3.14159265359/180.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sign_Box = findViewById(R.id.sign);
    ...
    public void btn_equal(View view) {
        if (sign == null) {
            ...
            sign_Box.setText("Error!");
        } else if ((sign.equals("+") || sign.equals("-") || sign.equals("*") || sign.equals("/")||sign.equals("power")) && val_1.equals("")) {
            sign_Box.setText("Error!");
        } else {
            switch (sign) {
                default:
                ...
                case "sin":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.round(Math.sin(num1*deg)*100.0)/100.0 + "");
                    sign = null;
                    sign_Box.setText(null);
                    break;
                case "cos":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.round(Math.cos(num1*deg)*100.0)/100.0 + "");
                    sign = null;
                    sign_Box.setText(null);
                    break;
                case "tan":
                    val_1 = user_input.getText().toString();
                    num1 = Double.parseDouble((val_1));
                    user_input.setText(Math.round(Math.tan(num1*deg)*100.0)/100.0+"");
                    sign = null;
                    sign_Box.setText(null);
                    break;
                case "+":
